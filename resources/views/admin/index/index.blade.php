...
@include('templates.admin.header')
    ...
    <div class="statsRow">
        <div class="wrapper">
        	<div class="controlB">
            	<ul>
                	<li><a href="#" title=""><img src="{{$adminUrl}}/images/icons/control/32/plus.png" alt="" /><span>Add new session</span></a></li>
                    <li><a href="#" title=""><img src="{{$adminUrl}}/images/icons/control/32/database.png" alt="" /><span>New DB entry</span></a></li>
                    <li><a href="#" title=""><img src="{{$adminUrl}}/images/icons/control/32/hire-me.png" alt="" /><span>Add new user</span></a></li>
                    <li><a href="#" title=""><img src="{{$adminUrl}}/images/icons/control/32/statistics.png" alt="" /><span>Check statistics</span></a></li>
                    <li><a href="#" title=""><img src="{{$adminUrl}}/images/icons/control/32/comment.png" alt="" /><span>Review comments</span></a></li>
                    <li><a href="#" title=""><img src="{{$adminUrl}}/images/icons/control/32/order-149.png" alt="" /><span>Check orders</span></a></li>
                </ul>
                <div class="clear"></div>
            </div>
        </div>
    ...
    <div class="wrapper">
        ...
        <div class="widget chartWrapper">
            <div class="title"><img src="{{$adminUrl}}/images/icons/dark/stats.png" alt="" class="titleIcon" /><h6>Chart</h6></div>
        ...
        <div class="widgets">
            <div class="oneTwo">
                ...
                <div class="widget">
                    <div class="title"><img src="{{$adminUrl}}/images/icons/dark/users.png" alt="" class="titleIcon" /><h6>Partners list</h6></div>
                    <ul class="partners">
                        <li>
                            <a href="#" title="" class="floatL"><img src="{{$adminUrl}}/images/user.png" alt="" /></a>
                            <div class="pInfo">
                                <a href="#" title=""><strong>Dave Armstrong</strong></a>
                                <i>Creative director at Google Inc. Zurich</i>	
                            </div>
                            <div class="pLinks">
                                <a href="#" title="Direct call" class="tipW"><img src="{{$adminUrl}}/images/icons/pSkype.png" alt="" /></a>
                                <a href="#" title="Send an email" class="tipW"><img src="{{$adminUrl}}/images/icons/pEmail.png" alt="" /></a>
                            </div>
                            <div class="clear"></div>
                        </li>
                        <li>
                ...
                <div class="widget">
                    <div class="title"><img src="{{$adminUrl}}/images/icons/dark/stats.png" alt="" class="titleIcon" /><h6>Website statistics</h6></div>
                ...
                <div class="widget">
                    <div class="title"><img src="{{$adminUrl}}/images/icons/dark/refresh4.png" alt="" class="titleIcon" /><h6>Latest updates</h6></div>
            ...
            <div class="oneTwo">
                ...
                <div class="widget">
                    <div class="title">
                        ...
                        <div class="topIcons">
                            ...
                            <a href="#" class="tipS" title="Edit"><img src="{{$adminUrl}}/images/icons/editTop.png" alt="" /></a>
                        </div>
                    </div>
                    <div class="newOrder">
                        <div class="userRow">
                ...
                <!-- New users widget -->
                <div class="widget">
                    <div class="title"><img src="{{$adminUrl}}/images/icons/dark/add.png" alt="" class="titleIcon" /><h6>New users</h6></div>
                    <div class="wUserInfo">
                        <a href="#" title="" class="wUserPic"><img src="{{$adminUrl}}/images/user.png" alt="" /></a>
                        <ul class="leftList">
                ...
                <div class="widget">
                    <div class="title"><img src="{{$adminUrl}}/images/icons/dark/timer.png" alt="" class="titleIcon" /><h6>My tasks</h6><div class="num"><a href="#" class="blueNum">+245</a></div></div>
                    <table cellpadding="0" cellspacing="0" width="100%" class="sTable taskWidget">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="actBtns"><a href="#" title="Update" class="tipS"><img src="{{$adminUrl}}/images/icons/edit.png" alt="" /></a><a href="#" title="Remove" class="tipS"><img src="{{$adminUrl}}/images/icons/remove.png" alt="" /></a></td>
                            </tr>
                            <tr>
        ...
        <!-- Events calendar -->
        <div class="widget">
            <div class="title"><img src="{{$adminUrl}}/images/icons/dark/monthCalendar.png" alt="" class="titleIcon" /><h6>Events</h6></div>
        ...
        <div class="widget">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                <thead>
                    <tr>
                        <td><img src="{{$adminUrl}}/images/icons/tableArrows.png" alt="" /></td>
                        <td>Image</td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center"><a href="{{$adminUrl}}/images/big.png" title="" rel="lightbox"><img src="{{$adminUrl}}/images/user.png" alt="" /></a></td>
    	...
    	<!-- Dynamic table -->
        <div class="widget">
            <div class="title"><img src="{{$adminUrl}}/images/icons/dark/full2.png" alt="" class="titleIcon" /><h6>Dynamic table</h6></div>                          
